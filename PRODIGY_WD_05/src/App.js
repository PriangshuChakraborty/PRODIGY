...
function App() {
  ...
  return (
    <div className="flex justify-center align-middle bg-gray-800 w-[100vw] h-[100vh]">
      <div className=' flex flex-col justify-between align-middle w-[300px] lg:w-[500px]  bg-gradient-to-b from-black to-blue-700 p-3 my-auto rounded-2xl'>
        <div>
          <div className="flex justify-center pb-4">
            <label htmlFor="city" className="mr-2 text-base font-semibold text-white">City :</label>
            <input onChange={(e) => handleSearch(e)} id="city" placeholder="Enter Your city" className=" bg-white/20 rounded px-5 w-[60%] placeholder:text-white/60 placeholder:text-sm outline-none text-white text-sm py-1" />
            {isSearch && <Loading />}
          </div>
